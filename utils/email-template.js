...
export const emailTemplates = [
  ...
  {
    label: "6 days before reminder",
    generateSubject: (data) =>
      `📅 Reminder: Your ${data.subscriptionName} Subscription Renews in 6 Days!`,
    generateBody: (data) => generateEmailTemplate({ ...data, daysLeft: 6 }),
  },
  {
  ...
  },
  {
    ...
    generateSubject: (data) =>
      `⏳ ${data.subscriptionName} Renews in 4 Days – Stay Subscribed!`,
  ...
  },
  {
    ...
    generateSubject: (data) =>
      `⚡ Final Reminder: ${data.subscriptionName} Renews Todayyy!`,
